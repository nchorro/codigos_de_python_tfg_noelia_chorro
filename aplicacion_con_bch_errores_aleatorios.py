...
CON ALGORITMO DE DECODIFICACIÓN DE CÓDIGOS BCH: ERRORES ALEATORIOS
"""
...
# Se graba c1 en el CD y ocurren los errores aleatorios
r1 = deepcopy(c1)
for j in range(6*n1):
     k = random.randint(0, 108)
     l = random.randint(0, n1-1)
     r1[k][l] = [random.randint(0,1) for x in range(8)]
